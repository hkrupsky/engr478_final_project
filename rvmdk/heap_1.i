#line 1 "FreeRTOS\\portable\\MemMang\\heap_1.c"
...
#line 38 "FreeRTOS\\portable\\MemMang\\heap_1.c"
...
#line 45 "FreeRTOS\\portable\\MemMang\\heap_1.c"
...
#line 46 "FreeRTOS\\portable\\MemMang\\heap_1.c"
...
{
void *pvReturn = 0;
static uint8_t *pucAlignedHeap = 0;
	...
	vTaskSuspendAll();
	{
		...
		if( ( ( xNextFreeByte + xWantedSize ) < ( ( ( size_t ) ( 8192 ) ) - 8 ) ) &&
...
#line 118 "FreeRTOS\\portable\\MemMang\\heap_1.c"
...
void vPortFree( void *pv )
{
	...
	if( ( pv == 0 ) == 0 ) { vPortRaiseBASEPRI(); for( ;; ); };
}
...
size_t xPortGetFreeHeapSize( void )
{
	return ( ( ( ( size_t ) ( 8192 ) ) - 8 ) - xNextFreeByte );
}
